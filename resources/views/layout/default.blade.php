...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Atsava | Open Source Enterprise Portal Framework</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
		...
		<!--end::Scrolltop-->		
		<script>var HOST_URL = "https://github.com/atulforever/atsava/";</script>
		...
		<script src="{{ asset('assets/plugins/custom/gmaps/gmaps.js?v=7.0.5') }}"></script>
		<!--end::Page Vendors-->
